...
test('test if result matches expected output with package.json', (t) => {
...
test('test if result matches expected output with file.js', (t) => {
...
test('test if result matches expected output with file.json', (t) => {
